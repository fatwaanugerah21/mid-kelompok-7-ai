          ...
          document.getElementById("startButtonStart").onclick = () => {
            if (!this.currentAlgorithm) {
              document.getElementById("startButtonStart").innerHTML =
                '<button class="btn btn-default navbar-btn" type="button">Pilih Algoritma!</button>';
            } else {
              ...
              let timeComplexity = endTime - startTime;
              document.getElementById(
                "timingInformation"
              ).innerHTML = `<div id="timingInformation">${this.currentAlgorithm} selesai dalam ${timeComplexity}ms</div>`;
            }
          };
        ...
        Board.prototype.toggleButtons = function () {
          ...
          if (!this.buttonsOn) {
            ...
            document.getElementById("startButtonDFS").className =
              "navbar-inverse navbar-nav collapse";
            ...
            document.getElementById("startStairDemonstration").className =
              "navbar-inverse navbar-nav disabledA";
            document.getElementById("startButtonDFS").className =
              "navbar-inverse navbar-nav disabledA collapse";
            document.getElementById("startButtonBFS").className =
              "navbar-inverse navbar-nav disabledA collapse";
            document.getElementById("startButtonDijkstra").className =
              "navbar-inverse navbar-nav disabledA";
            ...
            document.getElementById("startButtonAStar3").className =
              "navbar-inverse navbar-nav disabledA collapse";
            document.getElementById("startButtonBidirectional").className =
              "navbar-inverse navbar-nav disabledA collapse collapse";
